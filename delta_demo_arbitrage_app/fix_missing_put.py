...
# The missing put leg from the active position
PUT_SYMBOL = 'BTC/USD:USD-260731-85000-P'
PUT_QTY = 3
...
# Try market order, then aggressive limit
...
try:
    ...
    limit_p = round(p_ask * 1.10, 1)  # 10% above mark for deep ITM put
...
# Update state file to reflect actual put entry
...
if state.get('active_position'):
    ...
    state['active_position']['put']['entry_price'] = fill
