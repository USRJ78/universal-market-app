...
class StrategyHelper:
    def __init__(self, workspace_dir=None):
        if workspace_dir is None:
            # Dynamically resolve repository root based on the location of this file
            # Since strategy_helper.py is in the root of the repository, its directory is the workspace dir!
        ...
        self.strategies = {
            ...
            "Deep ITM Strangle (Synthetic Arbitrage)": {
                "file": "market_geometry_results.xlsx",
                "sheet": "Trades",
                "type": "trade_log",
                "date_col": "Exit Date",
                "profit_col": "Profit",
                "initial_capital": 100000.0,
                "desc": "A delta-neutral, volatility-neutral box spread/synthetic arbitrage strategy that targets risk-free yield with 0% drawdown."
            },
            "Swarm Bot 1x2 Ratio Call Spread": {
                "file": "call_spread_v4_results.xlsx",
                "sheet": "All Trades",
                "type": "trade_log",
                "date_col": "Exit_Date",
                "profit_col": "PnL_Total",
                "initial_capital": 100000.0,
                "desc": "Multi-Agent Swarm Bot executing 1x2 zero-net debit ratio call spreads on top momentum breakout stocks (Win Rate 79.3%, PF 34.55)."
            }
        }
        self.cached_curves = {}
        self.cached_trades = {}
    ...
    def get_file_path(self, filename):
        path1 = os.path.join(self.workspace_dir, filename)
        if os.path.exists(path1):
            return path1
        path2 = os.path.join(self.workspace_dir, "analysis", filename)
